...
class Payment extends Base
{
    ...
    public function pay()
    {
        ...
        /**
         * Gathered all user info data
         */
        $this->form_fields = $data_fields;

        /**
         * Process the form according to the user info
         */
        $this->process();

        /**
         * We don't know what error should we output because all the expected error
         * will be output inside the $this->process() method. Just output the
         * payment error id. Atleast we know there is an error.
         */
    ...
    {
        $paymentMode = Pluggable::paymentMode();
